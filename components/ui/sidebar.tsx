...
>(({ className, showIcon = false, ...props }, ref) => {
  // Varied width between 50% and 90%, derived from the React id.
  //
  // The upstream version called `Math.random()` during render, which returns
  // different values on the server and in the browser and so mismatched on
  // hydration. `useId()` is stable across both, and hashing it still gives
  // each skeleton row a different width.
