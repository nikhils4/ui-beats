...
export const HeroSection = () => {
  let libraryName = "Gravity Text Swap Component";
    ...
    >
      <div className="flex flex-col items-start gap-6 px-7 pb-8 text-center md:items-center md:px-10">
        <motion.div variants={itemVariants}>
          <Link href="/docs/modern-animation/gravity-text-swap">
        ...
        <motion.div variants={itemVariants} className="relative flex flex-col gap-10 md:items-center lg:flex-row mt-6">
        ...
        <motion.p variants={itemVariants} className="max-w-xl mt-6 mb-6 text-balance text-left text-base tracking-tight text-black dark:font-medium dark:text-white md:text-center md:text-lg ">
