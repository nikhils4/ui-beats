 ...
 *
 * Split per component for the same reason the preview map is: a docs page
 * should download the one harness it renders, not all of them. A component
 * with no entry here has no playground, and its docs page simply omits the
 * section.
 */
